...
public class staffDetails
{
    public static void main(String[] args)
    {
		...
		staff[0]=new Teaching(0001,"Naruto","271173",90000,"CSE",3);
		staff[1]=new Technical(0002,"Gojo","271172",2000,"Server Admin");
		staff[2]=new Contract(0003,"Goku","271174",9000,3);
