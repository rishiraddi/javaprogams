...
{
	int N = 2;
	Node root = new Node(N,5);
	root.children[0] = new Node(N, 4);
	root.children[1] = new Node(N, 9);
	root.children[0].children[0] = new Node(N, 1);
	root.children[0].children[1] = new Node(N, 10);
	root.children[1].children[1] = new Node(N, 7);
